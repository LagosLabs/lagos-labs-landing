...
export default function BlogSoa() {
  ...
  return (
    ...
    {/* Start Page Heading Section */}
      <PageHeading 
        title='Web 3 Professionals'
        bgSrc='/images/blog_details_hero_bg.jpeg'
        pageLinkText='Web 3 Professionals'
      />
            ...
            <Div className="cs-post cs-style2">
              ...
              <Div className="cs-post_info">
                <Div className="cs-post_meta cs-style1 cs-ternary_color cs-semi_bold cs-primary_font">
                  ...
                  <Link to="/blog/a-case-for-data-engineers" className="cs-post_avatar">Blockchain</Link>
                </Div>
                <h2 className="cs-post_title">The important roles every web 3 team needs to have</h2>
